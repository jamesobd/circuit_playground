...
while True:
    ...
    cpu_temp_color_red = int(simpleio.map_range(cpu_temp,20,40,0,255)) # Scale the value of temp from (20, 40) to (0, 255)
    cpu_temp_color_blue = 255 - cpu_temp_color_red
    therm_temp_color_red = int(simpleio.map_range(therm_temp, 15, 40, 0, 255)) # Scale the value of temp from (15, 40) to (0, 255)
